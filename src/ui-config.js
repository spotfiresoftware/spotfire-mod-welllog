...
insertDropdown = function(divContent, templateIdx, curveIdx, templates, name, allDataViewRows) {
    ...
    $("#dropdown" + name + "_" + templateIdx + "_" + curveIdx).ddslick({
        ...
        onSelected: function (data) {
            ...
            PropertyOnChange(templateIdx, curveIdx, templates, allDataViewRows, selData, name);
        }
    });
}

export function insertTextInput(divContent, i, k, templates, propName, allDataViewRows) {
    var selectedData = "";
