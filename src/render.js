...
export async function render(state, mod, dataView, windowSize, verticalZoomHeightProperty) {
    ...
    !_isInitialized && createConfigPopup();
    
    //makes the vanilla_drawer draggable
    ui_config.draggable(document.getElementById("drawer_menu"));
...
//JLL: move to different module.
//plot_templates[4]=test_templates[4]
